...
import { ListaAlumnoComponent } from '../../routes/list-alumnos/list-alumnos.component';
import { EditarAlumnoComponent } from '../../components/editar-alumno/editar-alumno.component';
import { AgregarAlumnoComponent } from '../../routes/agregar-alumno/agregar-alumno.component';
const routes: Routes = [
  {
    path: '',
